  ...
  return (
    <div className="min-h-screen flex flex-col font-sans relative">
      ...
      <div className="fixed inset-0 w-full h-full z-[-1] print:hidden overflow-hidden bg-[#020617]">
        ...
        {/* Animated Glowing Orbs (Optimized with radial gradients to avoid CPU/GPU blur overhead) */}
        <motion.div 
          animate={{ 
            scale: [1, 1.15, 1],
            opacity: [0.3, 0.5, 0.3],
          ...
          className="absolute top-1/4 -left-20 w-[400px] h-[400px] rounded-full pointer-events-none"
          style={{
        ...
        <motion.div 
          ...
          className="absolute bottom-1/4 -right-20 w-[500px] h-[500px] rounded-full pointer-events-none"
          style={{
